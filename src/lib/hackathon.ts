...
export const SPRINT_BLOCKS: SprintBlock[] = [
  ...
  },
  {
    ...
    subSteps: [
      { stepKey: "how_might_we", title: "איך נוכל…", minutes: 10, url: "/hmw", role: "designer" },
      { stepKey: "ideation", title: "סיעור רעיונות", minutes: 30, url: "/ideation", role: "designer" },
      { stepKey: "effort_impact", title: "מה לבנות עכשיו", minutes: 15, url: "/effort-impact", role: "designer" },
    ],
  },
  {
    key: "build",
    emoji: "🛠️",
    title: "הבנייה",
    tagline: "תכינו דמו אמיתי, לא שקפים",
    minutes: 180,
    color: "hsl(210, 80%, 55%)",
    leadRole: "builder",
    deliverables: [
    ...
    subSteps: [
      { stepKey: "storyboard", title: "סטוריבורד", minutes: 30, url: "/storyboard", role: "designer" },
      { stepKey: "prototype_brief", title: "בריף לאב-טיפוס", minutes: 20, url: "/prototype-brief", role: "builder" },
      { stepKey: "prd_generator", title: "PRD ← Lovable", minutes: 120, url: "/prd", role: "builder" },
    ],
  },
  {
    key: "pitch",
    emoji: "🎤",
    title: "הפיץ׳",
    tagline: "60 שניות שמוכרות את כל היום",
    minutes: 60,
    color: "hsl(280, 70%, 60%)",
    leadRole: "pitcher",
    deliverables: [
    ...
    subSteps: [
      { stepKey: "pitch", title: "סקריפט + שקפים", minutes: 40, url: "/pitch", role: "pitcher" },
