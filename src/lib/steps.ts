...
export const STEPS: StepConfig[] = [
  ...
  },
  {
    ...
    phase: "problem",
    description: "הצהרת נקודת מבט מזקקת את כל מה שלמדתם למשפט אחד ברור ופעיל: [משתמש] צריך [צורך] כי [תובנה]. השלב הזה נוצר אוטומטית ממה שכבר שיתפתם.",
    whyItMatters: "הצהרת POV מעוצבת היטב ממקדת את היצירתיות. בלעדיה, סיעור מוחות מתפזר לכל כיוון.",
  },
  {
    key: "how_might_we",
    num: 5,
    ...
    phase: "problem",
    description: "שאלות \"איך נוכל\" ממסגרות בעיות כהזדמנויות. ה-POV יובא אוטומטית מהשלב הקודם.",
